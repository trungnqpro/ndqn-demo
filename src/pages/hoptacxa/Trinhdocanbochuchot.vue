                    ...
                    <div class="mt-5 md:col-span-12 md:mt-0">
                        <div class="shadow sm:overflow-hidden sm:rounded-md grid grid-cols-12 ">
                            <div class="sm:col-span-6 col-span-12  bg-white px-4 py-5 sm:p-4">
                                ...
                                <input v-model="dataForm.ChucDanh" name="ChucDanh" type="text" required
                                    class="block w-full appearance-none rounded-md border border-gray-300 px-3 py-2 placeholder-gray-400 shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500 sm:text-sm">
                                <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('ChucDanh')">
                                    {{ dataForm.errors().get('ChucDanh') }}
                                </span>
                            </div>
                    ...
                    <div class="mt-5 md:col-span-12 md:mt-0">
                        <div class="shadow sm:overflow-hidden sm:rounded-md grid grid-cols-12 ">
                            ...
                            <div class="sm:col-span-6 col-span-12  bg-white px-4 py-5 sm:p-4">
                                ...
                                <select v-model="dataForm.TrinhDoID"
                                    class="rounded-md border-2 p-2 form-control form-select px-5 w-full">
                                    <option selected value="">-- Chọn: --</option>
                                ...
                                <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('TrinhDoID')">
                                    {{ dataForm.errors().get('TrinhDoID') }}
                                </span>
                            </div>
                        </div>
                    </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column prop="chucDanh" label="Chức Danh">
                    </el-table-column>
                    <!-- <el-table-column prop="tenTrinhDo" label="Trình Độ">
                    </el-table-column> -->
...
export default {
        ...
        return {
            ...
            dataForm: form({
                ...
                .messages({
                    ...
                    'TrinhDoID': 'Trường bắt buộc nhập',
    ...
    methods: {
        ...
        saveform() {
            this.dataForm.ChucDanh = '';
            this.dataForm.TrinhDoID = '';
        ...
        doAlertEdit(data) {
            ...
            const self = this;
            self.dataForm.ChucDanh = data.chucDanh;
            self.dataForm.TrinhDoID = data.trinhDoID;
