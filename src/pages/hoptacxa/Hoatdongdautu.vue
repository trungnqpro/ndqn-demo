            ...
            <div class="sm:w-6/12 w-10/12   p-5 relative mx-auto my-auto rounded-xl shadow-lg  bg-white">
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md grid grid-cols-12">
                        <div class=" col-span-12  bg-white px-4 sm:p-2">
                            
                            <label for="TongVonDieuLeDoanhNghiep"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tổng vốn điều lệ doanh
                                nghiệp:</label>
                            <input v-model="dataForm.TongVonDieuLeDoanhNghiep" type="text" name="TongVonDieuLeDoanhNghiep"
                                id="TongVonDieuLeDoanhNghiep" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                       focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                       dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                       dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tổng vốn điều lệ doanh nghiệp">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('TongVonDieuLeDoanhNghiep')">
                                {{ dataForm.errors().get('TongVonDieuLeDoanhNghiep') }}
                            </span>
                        </div>
                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md grid grid-cols-12">
                        <div class="col-span-12  bg-white px-4 sm:p-2">
                            ...
                            <label for="TongVonGop"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tổng Vốn Góp:</label>
                            <input v-model="dataForm.TongVonGop" type="text" name="TongVonGop" id="TongVonGop" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                       focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                       dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                       dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tổng Vốn Góp">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('TongVonGop')">
                                {{ dataForm.errors().get('TongVonGop') }}
                            </span>
                        </div>
                    ...
                    <div class="shadow sm:overflow-hidden sm:rounded-md grid grid-cols-12">
                        <div class="col-span-12  bg-white px-4 sm:p-2">
                            ...
                            <label for="TongCoPhan"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tổng Cổ Phần:</label>
                            <input v-model="dataForm.TongCoPhan" type="text" name="TongCoPhan" id="TongCoPhan" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                       focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                       dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                       dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tổng Cổ Phần">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('TongCoPhan')">
                                {{ dataForm.errors().get('TongCoPhan') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column prop="tongVonDieuLeDoanhNghiep" label="Tổng vốn điều lệ doanh nghiệp">
                    </el-table-column>
                    <el-table-column prop="tongCoPhan" label="Tổng Cổ Phần">
                    </el-table-column>
                    <el-table-column prop="tongVonGop" label="Tổng Vốn Góp">
                    </el-table-column>
...
export default {
        ...
        return {
            ...
            dataForm: form({
                ...
                .messages({
                    ...
                    'TongVonGop': 'Trường bắt buộc nhập',
                    'TongCoPhan': 'Trường bắt buộc nhập',
                }),
            rowId: '',
            statusForm: '',
            isActivemodal: true,
    ...
    methods: {
        ...
        saveform() {
            this.dataForm.TongVonDieuLeDoanhNghiep = '';
            this.dataForm.TongVonGop = '';
            this.dataForm.TongCoPhan = '';
        ...
        doAlertEdit(data) {
            ...
            self.dataForm.TongVonDieuLeDoanhNghiep = data.tongVonDieuLeDoanhNghiep;
            self.dataForm.TongVonGop = data.tongVonGop;
            self.dataForm.TongCoPhan = data.tongCoPhan;
            // Sửa tình trạng form
