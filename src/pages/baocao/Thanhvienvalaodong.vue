    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Báo cáo theo thành viên và lao động</h1>
                ...
                <template>
                    <el-table-column label="STT" width="100" align="left">
                        <template slot-scope="scope">
                            ...
                            <span class="sm:hidden idMobile py-3" style="margin-left: 10px">STT: {{ scope.row.stt }}</span>
                        </template>
                    </el-table-column>
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-row>
                                ...
                                <div class="px-2 sm:hidden idMobile">
                                    ...
                                    <span>mức độ hài lòng: <span v-if="scope.row.mucDoHaiLong == 1">Tốt </span>
                                        <span v-else-if="scope.row.mucDoHaiLong == 2">Khá </span>
                                        <span v-else-if="scope.row.mucDoHaiLong == 3">Trung bình </span>
                                        <span v-else>Kém </span></span>
                                </div>
                    ...
                    <el-table-column v-if="windowWidth > 767" label="Số lượng" align="left" width="150">
                        <template slot-scope="scope">
                            ...
                            <el-row>
                                <div class="px-2 " style="height: 100%;display: flex;align-items: center;">
                                    <span v-if="scope.row.mucDoHaiLong == 1">Tốt </span>
                                    <span v-else-if="scope.row.mucDoHaiLong == 2">Khá </span>
                                    <span v-else-if="scope.row.mucDoHaiLong == 3">Trung bình </span>
                                    <span v-else>Kém </span>
                                </div>
    ...
    data() {
        return {
            datatb: {
                ...
                // đường dẫn đến ajax
                url: '/DonVi/ThongKeThanhVienLaoDong',
            ...
            slots: [{
                ...
                prop: 'tongSoThanhVien'
            },
            {
                title: 'Số thành viên sử dụng dịch vụ',
                prop: 'soThanhVienSuDungDichVu'
            },
            {
                title: 'Tổng số lao động thường xuyên',
                prop: 'tongSoLaoDong'
            },
            {
                title: 'Số lao động là thành viên',
                prop: 'soLaoDongLaThanhVien'
            },
            {
                title: 'Trình độ lao động đại học/ trên đại học',
                prop: 'trinhDoLaoDongDaiHoc'
            },
            {
                title: 'Trình độ lao động trung cấp/ cao đẳng',
                prop: 'trinhDoLaoDongTrungCap'
            },
            {
                title: 'Trình độ lao động sơ cấp nghề',
                prop: 'trinhDoLaoDongSoCapNghe'
            },
            {
                title: 'Trình độ lao động chưa qua đào tạo',
                prop: 'trinhDoLaoDongChuaQuaDaoTao'
            },
            {
                title: 'Khung độ tuổi lao động',
                prop: 'khungDoTuoiLaoDong'
            },
            {
                title: 'Thành viên tham gia mới',
                prop: 'thanhVienThamGiaMoi'
            },
            {
                title: ' Thành viên là cá nhân',
                prop: 'thanhVienLaCaNhan'
            },
            {
                title: ' Thành viên là hộ gia đình',
                prop: 'thanhVienLaHoGiaDinh'
            },
            {
                title: 'Thành viên sử dụng sản phẩm dịch vụ',
                prop: 'thanhVienSuDungSanPhamDichVu'
            },
            {
                title: 'Lao động có tham gia bảo hiểm xã hội',
                prop: 'laoDongThamGiaBaoHiemXaHoi'
            },
            ],
