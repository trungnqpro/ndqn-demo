<style>
td.el-table__cell.is-left.el-table__cell {
    padding: 0px !important;
}

td.el-table__cell.is-left.el-table__cell .cell {
    padding: 0px !important;
}

td.el-table__cell.is-left.el-table__cell .cell .el-row {
    padding: 0px !important;
    border-top: 1px solid #e4e1e1 !important;
}

tr.el-table__row:hover td.el-table__cell.is-left.el-table__cell .cell .el-row {
    border-top: 1px solid #e4e1e1 !important;
}
</style>
<template>
...
export default {
    data() {
        return {
            ...
            listKybiendong: [],
            slots: [{
                title: 'Hỗ trợ đào tạo, bồi dưỡng nguồn',
                prop: 'chinhSach01'
            },
            {
                title: 'Hỗ trợ xúc tiến thương mại, mở rộng thị trường',
                prop: 'chinhSach02'
            },
            {
                title: 'Hỗ trợ ứng dụng công khoa học, công  kỹ thuật và công nghệ mới',
                prop: 'chinhSach03'
            },
            {
                title: 'Hỗ trợ tiếp cận vốn và quỹ hỗ trợ phát triển HND',
                prop: 'chinhSach04'
            },
            {
                title: 'Hỗ trợ tham gia các chương trình mục tiêu, chương trình phát triển KT-XH',
                prop: 'chinhSach05'
            },
            {
                title: 'Hỗ trợ thành lập mới',
                prop: 'chinhSach06'
            },
            {
                title: 'Hỗ trợ đầu tư phát triển kết cấu hạ tầng ',
                prop: 'chinhSach07'
            },

            {
                title: 'Diện tích đất được giao ',
                prop: 'chinhSach08'
            },
            {
                title: 'Diện tích đất được thuê',
                prop: 'chinhSach09'
            },
            {
                title: 'Tiền thuê đất được miễn, giảm',
                prop: 'chinhSach10'
            },
            {
                title: 'Số tiền được vay tổ chức tín dụng',
                prop: 'chinhSach11'
            },
            {
                title: 'Số tiền được hỗ trợ lãi suất vay',
                prop: 'chinhSach12'
            },
            {
                title: 'Hỗ trợ vốn, giống khi gặp khó khăn do thiên tai, dịch bệnh',
                prop: 'chinhSach13'
            },
            {
                title: 'Hỗ trợ chế biến sản phẩm',
                prop: 'chinhSach14'
            },
            {
                title: 'Khác (ghi cụ thể)',
                prop: 'chinhSach15'
            },
