    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Báo cáo theo trình độ cán bộ chủ chốt</h1>
    ...
    data() {
        return {
            datatb: {
                ...
                // đường dẫn đến ajax
                url: '/DonVi/ThongKeTrinhDoCanBoChuChot',
            ...
            listKybiendong: [],
            slots: [{
                title: 'Đại học, trên đại học',
                prop: 'daiHoc'
            },
            {
                title: 'Trung cấp, cao đẳng',
                prop: 'trungCapCaoDang'
            },
            {
                title: 'Sơ cấp nghề',
                prop: 'soCapNghe'
