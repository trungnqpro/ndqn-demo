    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Báo cáo kết quả kinh doanh QTDND</h1>
                        ...
                        <template slot-scope="scope">
                            <el-row>
                                <div class="px-2  idMobile1  sm:flex sm:items-center sm:h-full sm:overflow-auto">
                                    ...
                                    <span>Tổng số khách hàng đang vay vốn</span>
                                </div>
                                <div class="px-2 sm:hidden idMobile">

                                    <span>Tổng số khách hàng đang vay vốn: {{ scope.row.tongKhachHangDangVayvon }}</span>
                                </div>
                            ...
                            <el-row>
                                <div class="px-2  idMobile1  sm:flex sm:items-center sm:h-full sm:overflow-auto">
                                    ...
                                    <span>Tổng số thành viên đang vay vốn</span>
                                </div>
                                <div class="px-2 sm:hidden idMobile">

                                    <span>Tổng số thành viên đang vay vốn: {{ scope.row.tongThanhVienDangVayvon }}</span>
                                </div>
                            ...
                            <el-row>
                                <div class="px-2  idMobile1  sm:flex sm:items-center sm:h-full sm:overflow-auto">
                                    ...
                                    <span>Tổng dư nợ cho vay</span>
                                </div>
                                <div class="px-2 sm:hidden idMobile">

                                    <span>Tổng dư nợ cho vay: {{ scope.row.tongDuNoChoVay }}</span>
                                </div>
                            ...
                            <el-row>
                                <div class="px-2  idMobile1  sm:flex sm:items-center sm:h-full sm:overflow-auto">
                                    ...
                                    <span>Dư nợ cho vay thành viên</span>
                                </div>
                                <div class="px-2 sm:hidden idMobile">

                                    <span>Dư nợ cho vay thành viên: {{ scope.row.duNoChoVayThanhVien }}</span>
                                </div>
                            ...
                            <el-row>
                                <div class="px-2  idMobile1  sm:flex sm:items-center sm:h-full sm:overflow-auto">
                                    ...
                                    <span>Tổng lợi nhuận kế toán trước thuế thu nhập doanh nghiệp</span>
                                </div>
                                <div class="px-2 sm:hidden idMobile">

                                    <span>Tổng lợi nhuận kế toán trước thuế thu nhập doanh nghiệp: {{
                                        scope.row.loiNhuanKeToanTruocThue }}</span>
                                </div>
                            ...
                            <el-row>
                                ...
                                <div class="px-2 sm:hidden idMobile">
                                    ...
                                    <span>Tổng lợi nhuận sau nghĩa vụ tài chính: {{ scope.row.loiNhuanTrichQuyDTPT +
                                        ...
                                        scope.row.loiNhuanChiaThanhVienTheoKhac }}</span>
                                </div>
                        ...
                        <template slot-scope="scope">
                            <el-row>
                                <div class="px-2 " style="height: 100%;display: flex;align-items: center;">
                                    <span>{{ scope.row.tongKhachHangDangVayvon }}</span>
                                </div>

                            </el-row>
                            <el-row>
                                <div class="px-2 " style="height: 100%;display: flex;align-items: center;">
                                    <span>{{ scope.row.tongThanhVienDangVayvon }}</span>
                                </div>

                            </el-row>
                            <el-row>
                                <div class="px-2 " style="height: 100%;display: flex;align-items: center;">
                                    <span>{{ scope.row.tongDuNoChoVay }}</span>
                                </div>

                            </el-row>
                            <el-row>
                                <div class="px-2 " style="height: 100%;display: flex;align-items: center;">
                                    <span>{{ scope.row.duNoChoVayThanhVien }}</span>
                                </div>

                            </el-row>
                            <el-row>
                                <div class="px-2 " style="height: 100%;display: flex;align-items: center;">
                                    <span>{{ scope.row.loiNhuanKeToanTruocThue }}</span>
                                </div>
    ...
    data() {
        return {
            datatb: {
                ...
                // đường dẫn đến ajax
                url: '/DonVi/ThongKeKetQuaKinhDoanhQTDND',
            ...
            listKybiendong: [],
            slots: [{
                title: 'Tổng số khách hàng đang vay vốn',
                prop: 'tongKhachHangDangVayvon'
            },
            {
                title: 'Tổng dư nợ cho vay',
                prop: 'tongDuNoChoVay'
            },
            {
                title: 'Tổng lợi nhuận kế toán trước thuế',
                prop: 'loiNhuanKeToanTruocThue'
            },
            {
