    ...
    data() {
        return {
            datatb: {
                ...
                // đường dẫn đến ajax
                url: '/DonVi/ThongKeVonDieuLeDonVi',
            ...
            listKybiendong: [],
            slots: [{
                title: 'Tổng vốn điều lệ',
                prop: 'tongVonDieuLe'
            },
            {
                title: 'Tổng số thành viên góp vốn điều lệ',
                prop: 'tongThanhVienGop'
            },
            {
                title: 'Mức vốn góp thấp nhất/thành viên',
                prop: 'thapNhat'
            },
            {
                title: 'Mức góp vốn cao nhất/thành viên',
                prop: 'caoNhat'
            },
