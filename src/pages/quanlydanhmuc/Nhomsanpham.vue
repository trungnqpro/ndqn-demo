    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Quản lý nhóm sản phẩm</h1>
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên nhóm
                                sản phẩm:</label>
                            <input v-model="dataForm.tenNhomSanPham" type="text" name="tenNhomSanPham" id="tenNhomSanPham"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên nhóm sản phẩm">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenNhomSanPham')">
                                @@{{ dataForm.errors().get('tenNhomSanPham') }}
                            </span>
                        </div>
...
export default {
    data() {
        return {
            ...
            dataForm: form({
                ...
                .rules({
                    tenNhomSanPham: 'required',
                })
                .messages({
                    'tenNhomSanPham.required': 'Trường bắt buộc nhập',
                }),
            rowId: '',
            statusForm: '',
            isActivemodal: true,
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tenNhomSanPham = data.tenNhomSanPham;
            // Sửa tình trạng form
