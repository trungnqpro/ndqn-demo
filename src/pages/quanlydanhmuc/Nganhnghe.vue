    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Quản lý ngành nghề</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên ngành
                                nghề:</label>
                            <input v-model="dataForm.TenNganhNghe" type="text" name="TenNganhNghe" id="TenNghanhNghe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên ngành nghề">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('TenNganhNghe')">
                                {{ dataForm.errors().get('TenNganhNghe') }}
                            </span>
                        </div>
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Mã ngành
                                nghề:</label>
                            <input v-model="dataForm.maNganhNghe" type="text" name="maNganhNghe" id="TenNghanhNghe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Mã ngành nghề">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('maNganhNghe')">
                                {{ dataForm.errors().get('maNganhNghe') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên ngành nghề" prop="tenNganhNghe">
                        <template slot-scope="scope">
                            <span class="sm:hidden "><b>
                                    Tên ngành nghề:</b></span> {{ scope.row.tenNganhNghe }}

                        </template>

                    </el-table-column>
                    <el-table-column label="Mã ngành nghề" prop="maNganhNghe">
                        <template slot-scope="scope">
                            <span class="sm:hidden "><b>
                                    Mã ngành nghề:</b></span> {{ scope.row.maNganhNghe }}
...
export default {
    data() {
        return {
            ...
            dataForm: form({
                ...
                .rules({
                    TenNganhNghe: 'required',
                    maNganhNghe: 'required',

                })
                .messages({
                    'TenNganhNghe.required': 'Trường bắt buộc nhập',
                    'maNganhNghe.required': 'Trường bắt buộc nhập',
                }),
            rowId: '',
            statusForm: '',
            isActivemodal: true,
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.maNganhNghe = data.maNganhNghe;
            this.rowId = data.id;
