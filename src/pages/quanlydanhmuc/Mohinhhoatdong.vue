    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Quản lý mô hình hoạt động</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên mô
                                hình hoạt động:</label>
                            <input v-model="dataForm.tenMoHinhHoatDong" type="text" name="tenMoHinhHoatDong"
                                id="tenMoHinhHoatDong" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                               focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                               dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                               dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên mô hình hoạt động">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenMoHinhHoatDong')">
                                @@{{ dataForm.errors().get('tenMoHinhHoatDong') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên mô hình hoạt động" prop="tenMoHinhHoatDong">

                        <template slot-scope="scope">
                            <span class="sm:hidden "><b>
                                    Tên mô hình hoạt động:</b></span> {{ scope.row.tenMoHinhHoatDong }}
...
export default {
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tenMoHinhHoatDong = data.tenMoHinhHoatDong;
            // Sửa tình trạng form
