    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Chứng nhận sản phẩm</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Chứng
                                nhận sản phẩm:</label>
                            <input v-model="dataForm.tieuDe" type="text" name="tieuDe" id="tieuDe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên chứng nhận sản phẩm">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tieuDe')">
                                @@{{ dataForm.errors().get('tieuDe') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên chứng nhận sản phẩm" prop="tieuDe">
                        <template slot-scope="scope">

                            <span class="sm:hidden"><b>Tên chứng nhận sản phẩm:</b> </span>{{ scope.row.tieuDe }}
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tieuDe = data.tieuDe;
            // Sửa tình trạng form
