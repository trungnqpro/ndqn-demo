    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Lĩnh vực hoạt động</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Lĩnh vực
                                hoạt động:</label>
                            <input v-model="dataForm.tenLinhVucHoatDong" type="text" name="tenLinhVucHoatDong"
                                id="tenLinhVucHoatDong" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên lĩnh vực hoạt động">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenLinhVucHoatDong')">
                                @@{{ dataForm.errors().get('tenLinhVucHoatDong') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên lĩnh vực hoạt động" prop="tenLinhVucHoatDong">
                        <template slot-scope="scope">

                            <span class="sm:hidden"><b>Tên lĩnh vực hoạt động:</b> </span>{{ scope.row.tenLinhVucHoatDong }}
                        </template>
                    </el-table-column>
...
export default {
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tenLinhVucHoatDong = data.tenLinhVucHoatDong;
            // Sửa tình trạng form
