            ...
            <div class="w-full  overflow-auto ">
                ...
                <div class="grid grid-cols-12 ">
                    <div class="col-span-12">
                        <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên trình độ:</label>
                        <input v-model="dataForm.tenTrinhDo" type="text" name="tenTrinhDo" id="tenTrinhDo" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Tên trình độ">
                        <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenTrinhDo')">
                            {{ dataForm.errors().get('tenTrinhDo') }}
                        </span>
                    </div>
    ...
    <div>
        <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
            <template>
                ...
                <el-table-column label="Tên trình độ" prop="tenTrinhDo">
                    <template slot-scope="scope">
                        <span class="sm:hidden "><b>
...
export default {
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tenTrinhDo = data.tenTrinhDo;
            // Sửa tình trạng form
