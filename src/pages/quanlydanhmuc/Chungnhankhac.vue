    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Chứng nhận khác</h1>
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            ...
                            <input v-model="dataForm.tieuDe" type="text" name="tieuDe" id="tieuDe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                ...
                                placeholder="Tên chứng nhận khác">
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên chứng nhận khác" prop="tieuDe">
                        <template slot-scope="scope">

                            <span class="sm:hidden"><b>Tên chứng nhận khác:</b> </span>{{ scope.row.tieuDe }}
                        </template>
                    </el-table-column>
