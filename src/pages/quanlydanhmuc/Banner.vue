    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Banner</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        ...
                        <div class="col-span-12  bg-white  py-5 ">
                            ...
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('status')">
...
export default {
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.data.status = data.status;
            // Sửa tình trạng form
