    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Nhóm đơn vị</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên nhóm
                                đơn vị:</label>
                            <input v-model="dataForm.tenNhomDonVi" type="text" name="tenNhomDonVi" id="tenNhomDonVi" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên nhóm đơn vị">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenNhomDonVi')">
                                {{ dataForm.errors().get('tenNhomDonVi') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên nhóm đơn vị" prop="tenNhomDonVi">
                        <template slot-scope="scope">
                            <span class="sm:hidden "><b>
                                    Tên nhóm đơn vị:</b></span> {{ scope.row.tenNhomDonVi }}
...
export default {
    data() {
        return {
            ...
            dataForm: form({
                ...
                .rules({
                    tenNhomDonVi: 'required',
                })
                .messages({
                    'tenNhomDonVi.required': 'Trường bắt buộc nhập',
                }),
            rowId: '',
            statusForm: '',
            isActivemodal: true,
    ...
    methods: {
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tenNhomDonVi = data.tenNhomDonVi;
            // Sửa tình trạng form
