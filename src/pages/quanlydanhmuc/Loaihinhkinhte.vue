    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Quản lý loại hình kinh tế</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            ...
                            <label for="tenLoaiHinhKinhTe"
                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tên Loại Hình Kinh
                                Tế:</label>
                            <input v-model="dataForm.tenLoaiHinhKinhTe" type="text" name="tenLoaiHinhKinhTe"
                                id="tenLoaiHinhKinhTe" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                               focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                               dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                               dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên Loại Hình Kinh Tế">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenLoaiHinhKinhTe')">
                                @@{{ dataForm.errors().get('tenLoaiHinhKinhTe') }}
                            </span>
                        </div>
                ...
                <template>
                    ...
                    <el-table-column label="Tên Loại hình kinh tế" prop="tenLoaiHinhKinhTe">
                        <template slot-scope="scope">
                            ...
                            <span class="sm:hidden"><b>Tên Loại hình kinh tế:</b> </span>{{ scope.row.tenLoaiHinhKinhTe }}
