    ...
    <div>
        <div class="text-gray-100 text-xl">
            <div class="p-2.5 mt-1  items-center">
                <h1 class="font-bold text-gray-600 text-[24px]  ">Hình thức khen thưởng</h1>
                ...
                <div class="w-full  overflow-auto ">
                    ...
                    <div class="grid grid-cols-12 ">
                        <div class="col-span-12">
                            <label for="Name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Hình thức
                                khen thưởng:</label>
                            <input v-model="dataForm.tenHinhThucKhenThuong" type="text" name="tenHinhThucKhenThuong"
                                id="tenHinhThucKhenThuong" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg
                                   focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5
                                   dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400
                                   dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                placeholder="Tên hình thức khen thưởng">
                            <span class="mt-4 mb-2 text-red-500" v-if="dataForm.errors().has('tenHinhThucKhenThuong')">
                                @@{{ dataForm.errors().get('tenHinhThucKhenThuong') }}
                            </span>
                        </div>
        ...
        <div>
            <Datatable :datatb="datatb" namePaging="pagination" @pagination="pagination">
                <template>
                    ...
                    <el-table-column label="Tên Danh hiệu thi đua" prop="tenHinhThucKhenThuong">
                        <template slot-scope="scope">

                            <span class="sm:hidden"><b>Tên Danh hiệu thi đua:</b> </span>{{ scope.row.tenHinhThucKhenThuong
                            }}
                        </template>
                    </el-table-column>
...
export default {
    data() {
        return {
            ...
            dataForm: form({
                ...
                .rules({
                    tenHinhThucKhenThuong: 'required',
                })
                .messages({
                    'tenHinhThucKhenThuong.required': 'Trường bắt buộc nhập',
                }),
            rowId: '',
            statusForm: '',
            isActivemodal: true,
    ...
    methods: {
        ...
        saveform() {
            this.dataForm.tenHinhThucKhenThuong = '';
        ...
        doAlertEdit(data) {
            ...
            this.dataForm.tenHinhThucKhenThuong = data.tenHinhThucKhenThuong;
            // Sửa tình trạng form
