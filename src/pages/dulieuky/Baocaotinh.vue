            ...
            <table class=" divide-y divide-gray-300 w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ Thongtinchung.chiTieu10 }}</td>
                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Chia theo lĩnh vực :</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ Thongtinchung.chiTieu14 }}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ Thongtinchung.chiTieu19 }}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ Thongtinchung.chiTieu20 }}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ ThongtinchungLHHTX.chiTieu01 }}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Tổng số HND thành viên</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ ThongtinchungLHHTX.chiTieu05 }}</td>

                    </tr>

                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Tổng số lao động thường <br class="xl:hidden"> xuyên</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{ ThongtinchungLHHTX.chiTieu10 }}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                <thead>
                    <tr class="divide-x divide-gray-200">
                        ...
                        <th scope="col" class="px-4 py-3.5 text-left text-sm font-semibold text-gray-900">HND</th>
                        <th scope="col" class="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 sm:pr-0">LH HND</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu02'][0]+TaiSanVonDieuLe['chiTieu03'][0]+TaiSanVonDieuLe['chiTieu04'][0]+TaiSanVonDieuLe['chiTieu05'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu02'][1]+TaiSanVonDieuLe['chiTieu03'][1]+TaiSanVonDieuLe['chiTieu04'][1]+TaiSanVonDieuLe['chiTieu05'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Tổng cộng tài sản :</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu06'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu06'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Tổng cộng nguồn vốn:</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu08'][0]+TaiSanVonDieuLe['chiTieu09'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu08'][1]+TaiSanVonDieuLe['chiTieu09'][1]}}</td>
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Tổng số vốn góp vào <br>
                            doanh nghiệp :</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu14'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu14'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Tổng giá trị cổ phần mua :</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu15'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu15'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu16'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu16'][1]}}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu10'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu10'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Tổng số thành viên <br> góp vốn điều lệ :</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu11'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu11'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Mức vốn góp thấp <br> nhất/thành viên:</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu12'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu12'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Mức góp vốn cao <br> nhất/thành viên:</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu13'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TaiSanVonDieuLe['chiTieu13'][1]}}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu01'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu01'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Từ HND cung ứng dịch vụ:</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu02'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu02'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Từ HND tạo việc làm:</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu04'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu04'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu05'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu05'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu06'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu06'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu07'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu07'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu11'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu11'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Tổng quỹ lương </td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu15'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhHTX['chiTieu15'][1]}}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                <thead>
                    <tr class="divide-x divide-gray-200">
                        ...
                        <th scope="col" class="px-4 py-3.5 text-left text-sm font-semibold text-gray-900">QTDND</th>
                        <th scope="col" class="py-3.5 pl-4 pr-4 text-left text-sm font-semibold text-gray-900 sm:pr-0">NHHTX</th>
                    </tr>
                </thead>
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu01'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu01'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Tổng dư nợ cho vay</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu03'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu03'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu05'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu05'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu06'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu06'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu07'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu07'][1]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 ">Tổng lợi nhuận chia cho <br class="sm:hidden "> thành viên </td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu11'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu11'][1]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu15'][0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{KetQuaKinhDoanhQTND['chiTieu15'][0]}}</td>
            ...
            <table class=" divide-y divide-gray-300 w-full">
                ...
                <tbody class="divide-y divide-gray-200 bg-white">
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu03[2] +TrinhDoCanBoChuChot.chiTieu04[2]+TrinhDoCanBoChuChot.chiTieu05[2] +TrinhDoCanBoChuChot.chiTieu07[2]+TrinhDoCanBoChuChot.chiTieu08[2] +TrinhDoCanBoChuChot.chiTieu09[2] +TrinhDoCanBoChuChot.chiTieu11[2]+TrinhDoCanBoChuChot.chiTieu12[2] +TrinhDoCanBoChuChot.chiTieu13[2] +TrinhDoCanBoChuChot.chiTieu15[2] +TrinhDoCanBoChuChot.chiTieu16[2]+TrinhDoCanBoChuChot.chiTieu17[2] }}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu03[3] +TrinhDoCanBoChuChot.chiTieu04[3]+TrinhDoCanBoChuChot.chiTieu05[3] +TrinhDoCanBoChuChot.chiTieu07[3]+TrinhDoCanBoChuChot.chiTieu08[3] +TrinhDoCanBoChuChot.chiTieu09[3] +TrinhDoCanBoChuChot.chiTieu11[3]+TrinhDoCanBoChuChot.chiTieu12[3] +TrinhDoCanBoChuChot.chiTieu13[3] +TrinhDoCanBoChuChot.chiTieu15[3] +TrinhDoCanBoChuChot.chiTieu16[3]+TrinhDoCanBoChuChot.chiTieu17[3] }}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu03[0] +TrinhDoCanBoChuChot.chiTieu04[0] +TrinhDoCanBoChuChot.chiTieu05[0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu03[1] +TrinhDoCanBoChuChot.chiTieu04[1] +TrinhDoCanBoChuChot.chiTieu05[1]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu03[2] +TrinhDoCanBoChuChot.chiTieu04[2] +TrinhDoCanBoChuChot.chiTieu05[2]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu03[3] +TrinhDoCanBoChuChot.chiTieu04[3] +TrinhDoCanBoChuChot.chiTieu05[3]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Giám đốc </td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu09[0] +TrinhDoCanBoChuChot.chiTieu07[0]+TrinhDoCanBoChuChot.chiTieu08[0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu09[1] +TrinhDoCanBoChuChot.chiTieu07[1]+TrinhDoCanBoChuChot.chiTieu08[1]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu09[2] +TrinhDoCanBoChuChot.chiTieu07[2]+TrinhDoCanBoChuChot.chiTieu08[2]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu09[3] +TrinhDoCanBoChuChot.chiTieu07[3]+TrinhDoCanBoChuChot.chiTieu08[3]}}</td>
                    ...
                    <tr class="divide-x divide-gray-200">
                        ...
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu12[0] +TrinhDoCanBoChuChot.chiTieu13[0] +TrinhDoCanBoChuChot.chiTieu11[0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu12[1] +TrinhDoCanBoChuChot.chiTieu13[1] +TrinhDoCanBoChuChot.chiTieu11[1]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu12[2] +TrinhDoCanBoChuChot.chiTieu13[2] +TrinhDoCanBoChuChot.chiTieu11[2]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu12[3] +TrinhDoCanBoChuChot.chiTieu13[3] +TrinhDoCanBoChuChot.chiTieu11[3]}}</td>

                    </tr>
                    <tr class="divide-x divide-gray-200">
                        <td class="whitespace-nowrap py-4 pl-4 pr-4 text-sm font-medium text-gray-900 "> Kế toán trưởng</td>

                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu15[0] +TrinhDoCanBoChuChot.chiTieu16[0]+TrinhDoCanBoChuChot.chiTieu17[0]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu15[1] +TrinhDoCanBoChuChot.chiTieu16[1]+TrinhDoCanBoChuChot.chiTieu17[1]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu15[2] +TrinhDoCanBoChuChot.chiTieu16[2]+TrinhDoCanBoChuChot.chiTieu17[2]}}</td>
                        <td class="whitespace-nowrap p-4 text-sm text-gray-500">{{TrinhDoCanBoChuChot.chiTieu15[3] +TrinhDoCanBoChuChot.chiTieu16[3]+TrinhDoCanBoChuChot.chiTieu17[3]}}</td>
...
export default {
    ...
    methods: {
        ...
        loadData() {
            ...
            axios.get("/BaoCaoII17/ThongTinChungHTX?kyBienDong=" + self.kyBienDongId)
                .then((res) => {

                    self.Thongtinchung = res.data;
                });
            axios.get("/BaoCaoII17/ThongTinChungLHHTX?kyBienDong=" + self.kyBienDongId)
                .then((res) => {

                    self.ThongtinchungLHHTX = res.data;
                });
            ...
            axios.get("/BaoCaoII17/KetQuaKinhDoanhHTX?kyBienDong=" + self.kyBienDongId)
                .then((res) => {

                    self.KetQuaKinhDoanhHTX = res.data;
                });
            axios.get("/BaoCaoII17/KetQuaKinhDoanhQTDND?kyBienDong=" + self.kyBienDongId)
                .then((res) => {

                    self.KetQuaKinhDoanhQTND = res.data;
                });
